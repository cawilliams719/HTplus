...
# July Temperatures Averages over 10 year period
NE1_select2 <- NE1_select %>% filter(month == "07") 
NE1_select3 <- NE1_select2 %>% summarise(
  Tmin = mean(Tmin), Tmeann = mean(Tmean), Tmax = mean(Tmax))
  
# after maybe write objects out as csv files?
```
