...
NE1_sf_tmp <- extent(NE1_sf)
nlcd_2005_proj <- projectRaster(from = nlcd_2005, res = 1000, crs = crs(NE1_sf), method = "ngb")

# define the spatial extent of the stations
NE1_extent <- extent(min(NE1_summary$longitude)-10, max(NE1_summary$longitude)+10, min(NE1_summary$latitude)-10, max(NE1_summary$latitude)+10)

# define current and future env. RasterStacks
temp_2005_crop = crop(nlcd_2005, NE1_extent)
```
